...
import '../../../../shared/services/oidc_service.dart' as import11;
import 'package:ngrouter/src/router/router.dart' as import12;
...
class _ViewCallbackComponentHost0 extends import9.HostView<import1.CallbackComponent> {
  ...
  void build() {
    ...
    this.component = (import5.isDevMode
        ? import10.debugInjectorWrap(import1.CallbackComponent, () {
            return import1.CallbackComponent(this.injectorGet(import11.OidcService, this.parentIndex), this.injectorGet(import12.Router, this.parentIndex));
          })
        : import1.CallbackComponent(this.injectorGet(import11.OidcService, this.parentIndex), this.injectorGet(import12.Router, this.parentIndex)));
