...
[JSON da fusão](benchmark-merge-increment-09.json): 200 funções iguais, 15 amostras
...
- [Comparação nativa](conformance-native-increment-09.json): **12 programas × O0/O2**,
...
- [Comparação JS](conformance-js-increment-09.json): **26 programas** com fusão,
