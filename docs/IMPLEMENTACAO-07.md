...
- [Relatório nativo bruto](conformance-native-increment-07.json), com toolchains,
...
[modo direto](conformance-increment-07.json) e [constantes](conformance-increment-07-constants.json).
