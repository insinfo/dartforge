...
Relatórios [JavaScript](conformance-js-increment-12.json) e
[nativo](conformance-native-increment-12.json).
...
[Dados brutos e ambiente](benchmark-closures-12.json). A saída tem 11.334 bytes
