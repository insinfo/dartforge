...
Relatórios: [modo direto](conformance-increment-05.json) e
[constantes](conformance-increment-05-opt.json). CI: Windows/Linux, Rustdoc sem avisos e
...
[Dados antes](benchmarks/increment-05-classes-before.json) e
[dados depois](benchmarks/increment-05-classes-after.json), incluindo amostras e ambiente.
...
[Dados brutos](benchmarks/increment-05-libraries.json). Cada fase foi medida separadamente;
