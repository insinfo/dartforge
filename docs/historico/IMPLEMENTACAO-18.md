...
Metadados e amostras: [benchmark-increment-18.json](dados/benchmark-increment-18.json).
...
- **41 casos diferenciais JS aprovados** contra dart2js 3.6.2 `-O2`, com folding
  e fusão habilitados: [relatório completo](dados/conformance-js-increment-18.json).
