...
- **42 casos diferenciais aprovados** contra dart2js 3.6.2 -O2, com folding e
  fusão habilitados: [resultados completos](dados/conformance-js-increment-19.json).
...
Metadados e amostras: [benchmark-increment-19.json](dados/benchmark-increment-19.json).
