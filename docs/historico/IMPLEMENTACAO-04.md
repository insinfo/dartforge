...
Relatórios: [direto](dados/conformance-increment-04.json) e
[constantes](dados/conformance-increment-04-opt.json). A divergência histórica conhecida de -O0
...
Dados brutos: [antes](dados/benchmarks/increment-04-before.json) e
[depois](dados/benchmarks/increment-04-after.json). As medições foram feitas sequencialmente,
...
[Relatório completo](dados/benchmarks/increment-04-process.json). O p95 com 5 amostras é o
