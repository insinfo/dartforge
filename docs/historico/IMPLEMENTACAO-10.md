...
- [Runner nativo](dados/conformance-native-increment-10.json): **14 casos × O0/O2**,
  fusão, GC stress e estatísticas ativados, equivalentes ao Dart VM/AOT 3.6.2.
- [Runner JS](dados/conformance-js-increment-10.json): **27 casos**, fusão ativada,
...
[Benchmark da fusão](dados/benchmark-merge-increment-10.json): 200 funções duplicadas,
