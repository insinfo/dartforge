...
- Relatórios: [direto](conformance-increment-06.json),
  [constantes](conformance-increment-06-constants.json) e
  [benchmark bruto](benchmarks/increment-06-libraries.json).
