# Serve um diretório de saída do `dartforge compile-js` por HTTP e (opcionalmente)
# abre-o no Edge headless, imprimindo o DOM e os erros do console.
#
# Uso:
#   pwsh scripts/servir.ps1 -Dir work/fe/out [-Porta 8765] [-Web C:/…/frontend/web] [-Headless]
#
...
# que o index injeta (`window.__erros`).
param(
